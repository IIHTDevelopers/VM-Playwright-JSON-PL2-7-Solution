...
/**
 * Creates an event, deletes it, and wait till   the updated event list laod.
...
/**
 * Creates an event, marks it inactive, and contain its status text.
 ...
 * and wait till the updated expense type list load.
 ...
 * and wait till the updated expense type list laod.
