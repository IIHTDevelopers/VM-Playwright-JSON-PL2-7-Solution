 ...
 */
  ...
  //   await this.empList.first().waitFor({ state: 'visible' });
 ...
 */
  ...
  async editQualification(editInput: string){
    ...
    // await this.empList.first().waitFor({ state: 'visible' });
    // await this.page.waitForTimeout(4000);
    // return this.empList.allInnerTexts();
    return "";
 ...
 */
  ...
  async addEducation(GPA:string){
    ...
    // await this.saveQualiBtn.click();
    // await this.page.locator("//div[contains(@class, 'orangehrm-container')]").nth(1).locator(`//div[@role='row']/div[4]//div[text()='${GPA}']`).waitFor({ state: 'visible' });
...
async deleteskills(year: number) {
    ...
    // await this.page.locator(`//div[contains(@class, 'oxd-table-row--with-border') and contains(.,'${year}')]//i[contains(@class,'bi-trash')]`).nth(0).waitFor({ state: 'visible' });
    ...
    // await this.page.waitForTimeout(1000);
    // await this.confirmDel.click();
    // await this.page.locator("//div[contains(@class, 'orangehrm-container')]").nth(2).waitFor({ state: 'visible' });
...
async selectDeleteSkills(year: number) {
    ...
    // await this.yearInput.nth(1).fill(year.toString());
    // await this.saveQualiBtn.nth(0).click();
    // await this.page.locator(`//div[contains(@class,'oxd-table-row--with-border') and contains(.,'${year}')]`).waitFor({ state: 'visible' }); 
    ...
    // await this.page.waitForTimeout(1000);
    // await this.confirmDel.click();
    // await this.page.locator("//div[contains(@class, 'orangehrm-container')]").nth(2).locator("//div[@role='row']/div[3]/div").nth(0).waitFor({ state: 'visible' });
    return this.page.locator("//div[contains(@class, 'orangehrm-container')]").nth(2).locator("//div[@role='row']/div[3]/div").allInnerTexts();
}
