 ...
 *
 * Fills company and job title, saves the entry, and wait till the updated list.
 *
 ...
 *
 * Updates the company name and wait till  the updated list load.
 *
 ...
 *
 * Adds a qualification with the provided company name, deletes it, and wait till the updated list load.
 *
 ...
 *
 * Selects specific checkboxes, deletes the entries, and wait till the toast confirmation message appear.
 *
 */
 ...
 */
  ...
  /**
 * Adds a skill with a given year, deletes it, and wait till the updated skills list laod.
 ...
 * deletes it via "Delete Selected" option, and wait till the updated skills list load.
 * @param year - The unique year value to identify the skill.
 */
